...
export function bookingGuestTemplate(data: BookingEmailData): string {
  ...
  const content = `
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin: 32px 0 16px;">
      <tr>
        <td align="left">
          <a href="${data.packageSlug ? packageUrl : "https://www.motherindiatourtravels.com/packages"}" target="_blank" style="display: inline-block; background-color: #0d395f; color: #ffffff; font-family: 'Outfit', sans-serif; font-size: 14px; font-weight: 600; text-decoration: none; padding: 12px 24px; border-radius: 6px; box-shadow: 0 4px 10px rgba(13, 57, 95, 0.15);">
...
export function bookingCompanyTemplate(data: BookingEmailData): string {
  ...
  const headerSpan = isPopup
    ? `<span style="font-size: 11px; font-weight: 600; color: #0d395f; text-transform: uppercase; letter-spacing: 1.5px; display: block; margin-bottom: 8px;">New Popup Inquiry</span>`
    : `<span style="font-size: 11px; font-weight: 600; color: #0d395f; text-transform: uppercase; letter-spacing: 1.5px; display: block; margin-bottom: 8px;">New Booking Inquiry</span>`;
  ...
  const content = `
        ...
        <td style="padding: 20px 24px;">
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
            ${detailsGridRow(
              ...
              data.guestName,
              "Email Address",
              `<a href="mailto:${data.guestEmail}" style="color: #0d395f; text-decoration: none;">${data.guestEmail}</a>`,
            )}
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 24px;">
      <tr>
        <td align="left">
          <a href="${packageUrl}" target="_blank" style="display: inline-block; background-color: #0d395f; color: #ffffff; font-family: 'Outfit', sans-serif; font-size: 14px; font-weight: 600; text-decoration: none; padding: 12px 24px; border-radius: 6px; box-shadow: 0 4px 10px rgba(13, 57, 95, 0.15);">
            Open Package Page
          </a>
        </td>
      </tr>
...
export function contactCompanyTemplate(data: ContactEmailData): string {
  const content = `
    <span style="font-size: 11px; font-weight: 600; color: #0d395f; text-transform: uppercase; letter-spacing: 1.5px; display: block; margin-bottom: 8px;">New Contact Message</span>
        ...
        <td style="padding: 20px 24px;">
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
            ${detailsGridRow(
              ...
              data.name,
              "Email Address",
              `<a href="mailto:${data.email}" style="color: #0d395f; text-decoration: none;">${data.email}</a>`,
            )}
            ${detailsGridRow(
              "Phone Number",
              data.phone || "—",
