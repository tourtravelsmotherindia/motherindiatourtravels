...
(gen_random_uuid(), 'What is your cancellation policy?', 'Our cancellation policy depends on the specific package and individual hotel policies. While some bookings are refundable, others are not. We strictly adhere to the terms and cancellation policies of the respective hotels and service providers. Please check the cancellation terms detailed on the package page, in your booking voucher, or refer to our Cancellation Policy page for complete details.', 4),
