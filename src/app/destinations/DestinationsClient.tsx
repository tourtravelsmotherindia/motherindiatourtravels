...
function DestinationsContent({
  ...
  const filteredDestinations = useMemo(() => {
    const list = destinationsData.filter((dest) => {
      // Location Filter
      const isDomestic = dest.countrySlug === "india";
      if (selectedLocation === "domestic" && !isDomestic) return false;
      if (selectedLocation === "international" && isDomestic) return false;
      ...
      if (searchQuery.trim()) {
        ...
        return matchName || matchState || matchCountry || matchDesc;
      }
    ...
    return list;
  }, [destinationsData, selectedType, selectedLocation, searchQuery, sortBy]);
  ...
  return (
    <PageShell companyData={companyData} ptClass="pt-24" bgClass="bg-white">
      <div className="layout-container py-24">
        ...
        <div className="bg-neutral-50/80 border border-neutral-200/50 rounded-3xl p-5 md:p-6 mb-10 flex flex-col gap-4 shadow-sm">
          {/* Main Search Row */}
            ...
            {showFilters && (
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  {/* Location Select (Domestic/International) */}
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest pl-1">
                      Region Scope
                    </span>
        ...
        <div ref={resultsContainerRef} className="scroll-mt-28">
          <div className="flex items-center justify-between mb-8 px-1">
            <p className="text-xs md:text-sm font-bold text-neutral-500 uppercase tracking-wider">
              ...
              {Math.min(currentPage * itemsPerPage, filteredDestinations.length)} of{" "}
          ...
          {filteredDestinations.length === 0 ? (
            <div className="text-center py-20 bg-neutral-50 border border-neutral-100 rounded-[2.5rem] mt-4">
              ...
              <p className="text-neutral-500 text-sm mt-2 max-w-sm mx-auto px-4 font-medium">
                We couldn&apos;t find any destinations matching your search terms or filters.
              </p>
              <button
                onClick={() => {
                  setSearchQuery("");
