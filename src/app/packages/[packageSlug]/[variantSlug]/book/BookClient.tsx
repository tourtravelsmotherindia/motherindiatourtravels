  ...
  const renderQuickSummary = () => (
    <div className="flex flex-col gap-4 font-sans text-xs md:text-sm">
      ...
      <div className="flex flex-col gap-2.5 font-sans">
        <div className="flex items-center justify-between text-xs font-semibold text-neutral-850 pb-1">
      ...
      <div className="layout-container font-sans">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[1fr_380px] gap-12 lg:gap-16 items-start pb-section-loose">
          ...
          <aside className="w-full lg:sticky lg:top-28 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4 font-sans text-xs md:text-sm mb-6">
