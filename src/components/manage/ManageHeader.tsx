      ...
      breadcrumbs.push(
        <React.Fragment key={segment}>
          ...
          {idx === segments.length - 2 ? (
            <span className="text-black font-semibold truncate">{label}</span>
          ) : (
    ...
    <header className="sticky top-0 bg-white border-b border-neutral-100 px-6 py-3.5 flex flex-col gap-3 z-20">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="flex items-center text-xs font-semibold text-black min-w-0 overflow-x-auto no-scrollbar">
            {generateBreadcrumbs()}
          </div>
        </div>
        ...
        <div className="hidden sm:flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 text-[10px] md:text-xs font-semibold px-4 py-1.5 rounded-full border border-neutral-100 bg-white text-neutral-600 shadow-[0_1px_4px_rgba(0,0,0,0.04)] leading-none shrink-0">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-black font-medium">API:</span>
            ...
            {deployStatus && (
              <>
                ...
                >
                  <span className="text-black font-medium">Deploy:</span>
                  <span
          ...
          <Link
            href="/manage/deploy/"
            className="flex items-center gap-1.5 text-xs text-black bg-white hover:bg-neutral-50 border border-neutral-100 px-4 py-1.5 rounded-full font-semibold shadow-[0_1px_4px_rgba(0,0,0,0.04)] transition-all duration-200 cursor-pointer shrink-0"
          >
      ...
      {/* Main Heading Text */}
      <div className="mt-1">
        <h1 className="text-xl md:text-2xl font-bold font-display text-black leading-tight">
          {heading}
        </h1>
        {sub && (
          <p className="text-xs md:text-sm text-black font-medium mt-1 leading-relaxed max-w-3xl">
            {sub}
          </p>
        )}
      </div>
